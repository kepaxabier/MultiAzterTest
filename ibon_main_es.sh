#Pasos:
#En /home/ibon/Escritorio/prueba/corpus/es/Cuentos/txt/Texto_1-50.txt (Simple)
#En /home/ibon/Escritorio/prueba/corpus/es/Cuentos/txt/Texto_51-100.txt (Complejo)

#OBTENER MULTIAZTERTEST EN 5 EN 5
function obtenerdatossimplecompuesto_es()
{
mkdir -p /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo
mkdir -p /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/simple
mkdir -p /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/complejo
for i in `seq 1 50`
do
cp /home/ibon/Escritorio/prueba/corpus/es/Cuentos/txt/Texto_$i.txt /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/simple
done
for i in `seq 51 100`
do
 cp /home/ibon/Escritorio/prueba/corpus/es/Cuentos/txt/Texto_$i.txt /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/complejo
done
#simple
dir="/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/simple"
...
#complejo
dir="/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/complejo"
#voy a dividir los ficheros en 5 en 5
cd $dir
has=51
buk=55
...
{
modelo=$1
cd /home/ibon/Escritorio/prueba
source bin/activate
...
do
	#with similarity
        python3 multiaztertest.py -s -c -r -f  $dir/$i/*.txt -l spanish -m $modelo -d "/home/ibon"
        #without similarity
        #python3 multiaztertest.py -c -r -f  $dir/$i/*.txt -l spanish -m $modelo -d "/home/ibon"
done
...
#python3 ./multiaztertest.py -s -c -r -f  $dir/55/Texto_53.txt -l spanish -m stanford -d "/home/ibon"
...
#output:/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/cross10$modelo/cross1/[train|test]
#test:
#input1: /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/simple/5/results/$dir2/full_results_aztertest_withlevel.csv +
#input2: /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/complejo/55/results/$dir2/full_results_aztertest_withlevel.csv

#Añade el nivel
#crea el fichero a concatenar
dir="/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/simple"
dir2="cubeconsimilitudconcontadores"
echo -e "level\n0\n0\n0\n0\n0\n" > $dir/simplelevel.txt
for i in `seq 5 5 50`
do
	paste -d',' $dir/$i/results/$dir2/full_results_aztertest.csv $dir/simplelevel.txt > $dir/$i/results/$dir2/full_results_aztertest_withlevel.csv
        head -n 6 $dir/$i/results/$dir2/full_results_aztertest_withlevel.csv > $dir/$i/results/$dir2/full_results_aztertest_withlevelgarbi.csv
	tail -n +2 $dir/$i/results/$dir2/full_results_aztertest_withlevelgarbi.csv > $dir/$i/results/$dir2/full_results_aztertest_withlevelsincab.csv
done
dir="/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/complejo"
#crea el fichero a concatenar
...
for i in `seq 55 5 100`
do
	paste -d',' $dir/$i/results/$dir2/full_results_aztertest.csv $dir/complejolevel.txt > $dir/$i/results/$dir2/full_results_aztertest_withlevel.csv
        head -n 6 $dir/$i/results/$dir2/full_results_aztertest_withlevel.csv > $dir/$i/results/$dir2/full_results_aztertest_withlevelgarbi.csv
	tail -n +2 $dir/$i/results/$dir2/full_results_aztertest_withlevelgarbi.csv > $dir/$i/results/$dir2/full_results_aztertest_withlevelsincab.csv
done
dir="/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo"
...
do
        ...
        j=`expr $i \* 5`
        k=`expr $j + 50`
        cat $dir/simple/$j/results/$dir2/full_results_aztertest_withlevelsincab.csv $dir/complejo/$k/results/$dir2/full_results_aztertest_withlevelsincab.csv > $dir/cross10$modelo/cross$i/test_sincab.csv
done
...
#Lortu burua
dir="/home/ibon/Escritorio/prueba/corpus/es/simplecomplejo"
head -n 1 $dir/simple/5/results/$dir2/full_results_aztertest_withlevel.csv > $dir/burua.csv
for i in `seq 1 10`
do
...
WEKA_PATH=/home/ibon/Sad/weka-3-9-4
export CLASSPATH=$CLASSPATH:/home/ibon/Sad/weka-3-9-4/weka.jar #:/usr/share/java/libsvm.jar:/usr/share/java
...
java -cp $CP -Xmx1024m --add-opens=java.base/java.lang=ALL-UNNAMED weka.filters.supervised.attribute.AttributeSelection \
    ...
    -b \
    -i /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/cross10$modelo/cross1/train_cab.nominal.arff \
    -o /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/cross10$modelo/cross1/train_cab.nominal.fs.arff \
    -r /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/cross10$modelo/cross1/test_cab.nominal.arff \
    -s /home/ibon/Escritorio/prueba/corpus/es/simplecomplejo/cross10$modelo/cross1/test_cab.nominal.fs.arff \
    -c last
...
export CLASSPATH=$CLASSPATH:/home/ibon/Sad/weka-3-9-4/weka.jar #:/usr/share/java/libsvm.jar:/usr/share/java
CP="$CLASSPATH:/usr/share/java/"
cd /home/ibon/Dropbox/aztertestnlpcube/dataset_aztertest_full
java -cp $CP -Xmx1024m weka.gui.explorer.Explorer
}
